...
var AuthorizationCodeGrantControl = /** @class */ (function (_super) {
    ...
    function AuthorizationCodeGrantControl(config, options) {
     ...
     */
    AuthorizationCodeGrantControl.prototype.getAuthUri = function (options) {
        var _a, _b, _c, _d;
        ...
        // query params
        var queryParams = {
            response_type: (_c = options === null || options === void 0 ? void 0 : options.responseType) !== null && _c !== void 0 ? _c : "code",
        ...
        // merged params
        var mergedParams = common_1.Obj.cleanWithEmpty(common_1.Obj.merge(queryParams, (_d = this.requestOptions.query) !== null && _d !== void 0 ? _d : {}));
    ...
    AuthorizationCodeGrantControl.prototype.getToken = function (params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var urlData_1, localState, localRedirectUrl, requestHeaders, requestBody, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 4, , 5]);
                        urlData_1 = (0, query_string_1.parseUrl)(params.callbackUrl);
                        localState = params.state;
                        localRedirectUrl = (_a = params === null || params === void 0 ? void 0 : params.redirectUri) !== null && _a !== void 0 ? _a : this.redirectUri;
                        // force array
                        ...
                        // state exists
                        if (urlData_1.query.state && !localState.includes(urlData_1.query.state)) {
                        ...
                        if (!urlData_1.query.code) return [3 /*break*/, 2];
                        requestHeaders = {};
                        requestBody = {
                            grant_type: "authorization_code",
                            code: urlData_1.query.code,
                            redirect_uri: localRedirectUrl,
                            state: localState,
                        };
                        /**
                        ...
                        if (this.options.basicAuthHeader === false) {
                            ...
                            requestHeaders["Authorization"] = (0, basicAuthFunc_1.default)(this.options.clientId, (_b = this.options.clientSecret) !== null && _b !== void 0 ? _b : "");
                        }
                        /**
                         * Request a token
                         */
                        return [4 /*yield*/, (0, helpers_1.requestToken)({
                                ...
                                onSuccess: function (data) {
                                    ...
                                    if (params.onSuccess)
                                        params.onSuccess(data, urlData_1.query.state);
                                },
                    ...
                    case 1:
                        ...
                        _c.sent();
                        return [3 /*break*/, 3];
                    case 2: throw urlData_1.query;
                    case 3: return [3 /*break*/, 5];
                    case 4:
                        error_1 = _c.sent();
                        if (params.onError) {
                            params.onError(error_1);
                        }
                        else {
                            throw error_1;
                        }
     ...
     */
    AuthorizationCodeGrantControl.prototype.refresh = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, helpers_1.refreshToken)({
                            accessTokenUrl: this.options.accessTokenUrl,
                            config: {
                                oauthOptions: this.oauthOptions,
                                requestOptions: this.requestOptions,
