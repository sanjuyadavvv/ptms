...
var ClientCredentialsGrantControl = /** @class */ (function (_super) {
    ...
    function ClientCredentialsGrantControl(config, options) {
     ...
     */
    ClientCredentialsGrantControl.prototype.getToken = function (params) {
        var _a;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (this.options.basicAuthHeader === false) {
                            ...
                            requestHeaders["Authorization"] = (0, basicAuthFunc_1.default)(this.options.clientId, (_a = this.options.clientSecret) !== null && _a !== void 0 ? _a : "");
                        }
                        /**
                         * Request a token
                         */
     ...
     * @param params parameters
     */
    ClientCredentialsGrantControl.prototype.refresh = function (params) {
        return __awaiter(this, void 0, void 0, function () {
