...
function refreshToken(props) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!props.params.token.refresh_token) return [3 /*break*/, 2];
                    requestHeaders = {};
                    requestBody = {
                    ...
                    if (props.config.oauthOptions.basicAuthHeader === false) {
                        ...
                        requestHeaders["Authorization"] = (0, basicAuthFunc_1.default)(props.config.oauthOptions.clientId, (_a = props.config.oauthOptions.clientSecret) !== null && _a !== void 0 ? _a : "");
                    }
                    /**
                     * Request a token
                     */
                    return [4 /*yield*/, (0, _1.requestToken)({
                ...
                case 1:
                    ...
                    _b.sent();
                    return [3 /*break*/, 3];
                case 2: throw new Error("Refresh token is required");
